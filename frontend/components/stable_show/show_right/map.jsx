...
class Map extends React.Component {
    ...
    searchAddress() {
        ...
        const query_string = this.props.address.split(' ').join('+');
        window.open(base_url + query_string, '_blank');
    }
    ...
    componentDidMount() {
        ...
        this.renderedMap = new google.maps.Map(mapNode, mapOptions);
    ...
    render() {
        return (
            <div className='map-outer-container'>
                <div className='map-inner-container' ref={this.map}></div>
                <p className='map-link'>
                    <i className='fas fa-horse-head'></i>
                    <span onClick={this.searchAddress}>{this.props.address}</span>
                </p>
            </div>
        );
    }
